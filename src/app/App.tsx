    ...
    <HelmetProvider>
      <Router>
        ...
        <Routes>
          ...
          {/* Redirect legacy URL to canonical /audit */}
          ...
          <Route path="/insights/why-employer-brands-fail" element={<PlaceholderPage title="Why Most Employer Brands Fail Before They Launch" />} />
          <Route path="/insights/job-board-strategy" element={<PlaceholderPage title="The Quiet Collapse of the Job Board Strategy" />} />
          <Route path="/insights/talent-maturity-gap" element={<PlaceholderPage title="Most Companies Are at Stage One" />} />
